...
module MsgType = Make(struct
    ...
    let t = MsgType
    let pp = Fixtypes.MsgType.pp_fix
    let tag = 35
...
module MaturityTime = Make(struct
    ...
    let t = MaturityTime
    let pp = Fixtypes.TZTimeOnly.pp_fix
...
module SecurityListRequestType = Make(struct
    ...
    let pp = SecurityListRequestType.pp_fix
...
module SecurityRequestResult = Make(struct
    ...
    let pp = SecurityRequestResult.pp_fix
...
module MassStatusReqType = Make(struct
    ...
    let pp = MassStatusReqType.pp_fix
...
module SubscriptionRequestType = Make(struct
    ...
    let pp = SubscriptionRequestType.pp_fix
...
module CxlRejResponseTo = Make(struct
    ...
    let pp = CxlRejResponseTo.pp_fix
...
module CancelOrdersOnDisconnect = Make(struct
    ...
    let pp = CancelOrdersOnDisconnect.pp_fix
...
module LastLiquidityInd = Make(struct
    ...
    let pp = LastLiquidityInd.pp_fix
